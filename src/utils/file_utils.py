...
class FileUtil:
    ...
    @staticmethod
    def dataframe2csv(input_dataframe, output_filename: str, header=False, index=False):
        """
        # Write data frame to csv file
        :param  input_dataframe: input pandas data frame
        :param  output_filename: output csv file name
        :param  index: Write out index
        :param  header: write out header
        """
        input_dataframe.to_csv(output_filename, index=index, header=header, encoding='utf-8')

    @staticmethod
    def csv2dataframe(input_filename: str):
        """
        # Read csv file to data frame
        :param  input_filename: input csv file
    ...
    @staticmethod
    def csv2list(input_filename: str):
        """
